...
if(isset($_POST["submitted"]) && !empty($_POST["submitted"]) && $_POST["submitted"] == 1)
{
    ...
    $from_fhone     = isset($_POST['phone']) ? trim(strip_tags($_POST['phone'])) : '';
    ...
    elseif($from_fhone  == "")
	{
		echo '<br clear="all"><div class="form_info" align="left">Please enter phone in the required field to proceed. Thanks.</div>';
	}
	elseif($from_email == "")
	{
